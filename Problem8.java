...
public final class Problem8 {
    private static final String THOUSAND_NUMS = 
    ...
    public static long problemEight() {
        ...
        for (int i = 12; i < THOUSAND_NUMS.length(); ++i) {
            long product = product(i-12,i);
    ...
    private static long product(int start, int end) {
        ...
        for (int i = start; i <= end; ++i) {
            final int digit = Character.digit(THOUSAND_NUMS.charAt(i), 10);
            product *= digit;
        }
        return product;
    }
